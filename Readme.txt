...
Name of the student ADITI BAGORA
Roll No CS21MTECH14007

compile : g++ *.cpp -o op.exe
                ./op.exe

The zip file also contains pcap files which are used to calculate download time for each iteration